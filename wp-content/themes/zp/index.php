...
<head>
	...
	<link rel="shortcut icon" href="<?php echo themePath(); ?>img/favicon/favicon.ico" type="image/x-icon">
	<link rel="apple-touch-icon" href="<?php echo themePath(); ?>img/favicon/apple-touch-icon.png">
	<link rel="apple-touch-icon" sizes="72x72" href="<?php echo themePath(); ?>img/favicon/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="114x114" href="<?php echo themePath(); ?>img/favicon/apple-touch-icon-114x114.png">
	...
	<script>!function(e) {
		...
		function a(t,a) {
			if(e.localStorage&&e.XMLHttpRequest)n(t,a)?o(localStorage[t+"_content"]):l(t,a);else{var s=r.createElement("link");s.href=a,s.id=t,s.rel="stylesheet",s.type="text/css",r.getElementsByTagName("head")[0].appendChild(s),r.cookie=t
		}
	}
	function l(e,t) {
		var n = new XMLHttpRequest;
		n.open("GET",t,!0) , n.onreadystatechange = function() {
			4 === n.readyState && 200 === n.status && (o (n.responseText), 
				localStorage[e+"_content"] = n.responseText, localStorage[e + "_file"] = t)
		}, n.send()
	}
	function o(e) {
	...
	var r=e.document;e.loadCSS=function(e,t,n) {
		var a, l = r.createElement("link");
		if(t) a = t; else {
			var o;o = r.querySelectorAll ? 
			r.querySelectorAll("style,link[rel=stylesheet],script") : 
			(r.body || r.getElementsByTagName("head")[0]).childNodes, a = o[o.length-1]
		}
		var s=r.styleSheets;l.rel = "stylesheet", l.href = e,l.media = "only x", 
		a.parentNode.insertBefore(l, t ? a : a.nextSibling);
		var c=function(e) {
	...
	<!-- Load CSS Start перед именами убрать слеши -->
	<script>loadLocalStorageCSS( "webfonts", "<?php echo themePath(); ?>css/fonts.min.css?ver=1.0.0" );</script>
	<script>loadCSS( "<?php echo themePath(); ?>css/header.min.css?ver=1.0.0", false, "all" );</script>
	<script>loadCSS( "<?php echo themePath(); ?>css/main.min.css?ver=1.0.0", false, "all" );</script>
	<!-- Load CSS End -->

	<!-- Load CSS Compilled without JS -->
	<noscript>
		<link rel="stylesheet" href="<?php echo themePath(); ?>css/fonts.min.css">
		<link rel="stylesheet" href="<?php echo themePath(); ?>css/main.min.css">
	</noscript>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-10 col-sm-9 col-xs-offset-1">
									<div class="row">
										<div class="col-md-6">
											<h2>Автопомощь<br> Эвакуация 24 часа в сутки</h2>
											<p> Эвакуация аварийных и неисправных автомобилей, массой до 3,5 тонн</p>
											<a href="avtopomoshch.html" class="button">Список услуг</a>
										</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-10 col-sm-9 col-xs-offset-1">
									<div class="row">
										<div class="col-md-6">
											<h2>Первая автопомощь<br> на дорогах Гомеля</h2>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="service-item">
							<a href="avtopomoshch.html" class="service-item-image" style="background-image: url(img/services/_1.jpg);">
							...
							<a href="avtopomoshch.html" class="button">Подробнее</a>
						</div>
					...
					<div class="col-md-3  col-sm-6">
						...
						<div class="service-item">
							<a href="avtopomoshch_na_doroge.html" class="service-item-image" style="background-image: url(img/services/_3.jpg);">
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
							<h4>Автопомощь на дороге</h4>
							<div class="service-item-stars">
								<i class="fa fa-star" aria-hidden="true"></i>
								<i class="fa fa-star" aria-hidden="true"></i>
								<i class="fa fa-star" aria-hidden="true"></i>
							...
							<a href="avtopomoshch_na_doroge.html" class="button">Подробнее</a>
						</div>
					...
					<div class="col-md-3  col-sm-6">
						...
						<div class="service-item">
							<a href="vip_taxi.html" class="service-item-image" style="background-image: url(img/services/_6.jpg);">
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
							<h4>Вип такси</h4>
							<div class="service-item-stars">
							...
							<div class="service-item-price">
								<i class="fa fa-tags" aria-hidden="true"></i> от <span>450 000</span> бр
							</div>
							<a href="vip_taxi.html" class="button">Подробнее</a>
						</div>
					...
					<div class="col-md-3  col-sm-6">
						...
						<div class="service-item">
							<a href="remont_akpp.html" class="service-item-image" style="background-image: url(img/services/_2.jpg);">
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
							<h4>Ремонт АКПП</h4>
							<div class="service-item-stars">
							...
							<a href="remont_akpp.html" class="button">Подробнее</a>
						</div>
					...
					<div class="col-md-3  col-sm-6">
						...
						<div class="service-item">
							<a href="shinomontage.html" class="service-item-image" style="background-image: url(img/services/_4.jpg);">
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
							<h4>Шиномонтаж</h4>
							<div class="service-item-stars">
							...
							<a href="shinomontage.html" class="button">Подробнее</a>
						</div>
					...
					<div class="col-md-3  col-sm-6">
						...
						<div class="service-item">
							<a href="remont_motorov.html" class="service-item-image" style="background-image: url(img/services/_5.jpg);">
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
							<h4>Ремонт моторов</h4>
							<div class="service-item-stars">
								<i class="fa fa-star" aria-hidden="true"></i>
								<i class="fa fa-star" aria-hidden="true"></i>
								<i class="fa fa-star" aria-hidden="true"></i>
							...
							<a href="remont_motorov.html" class="button">Подробнее</a>
						</div>
