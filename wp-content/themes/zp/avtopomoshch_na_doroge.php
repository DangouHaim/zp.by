...
<body class="isnohome">
				...
				<div class="row">
					<div class="col-md-9">
						...
						<article>
							...
							<p>
								Мы оказываем автопомощь на дороге по доступным ценам. Цены можно обсудить, связавшись с нами.
							</p>
						</article>
					...
					<aside class="main-aside">
						...
						<div class="top-panel-box">
									...
									<ul class="menu-type-2">
										...
										<li class="active"><a href="#"><span class="fa fa-check"></span>Автопомощь на дороге</a></li>
							...
							<div class="col-sm-6">
								...
								<div class="top-panel-box">
									...
									<ul class="menu-type-2ре">
										...
										<li><a href="remont_motorov.html"><span class="fa fa-check"></span>Ремонт моторов</a></li>
										<li><a href="remont_akpp.html"><span class="fa fa-check"></span>Ремонт АКПП</a></li>
										<li><a href="#"><span class="fa fa-check"></span>Автопомощь на дороге</a></li>
										<li><a href="vip_taxi.html"><span class="fa fa-check"></span>Вип такси</a></li>
									</ul>
								</div>
	...
	<div class="hidden">
		...
		<form class="popup-form callback zoom-anim-dialog" id="order">
			...
			<input type="hidden" name="project_name" value="Эвакуатор">
			<input type="hidden" name="admin_email" value="nx100@yandex.ru">
			<input type="hidden" name="form_subject" value="Заявка с сайта эвакуатор: заказ услуги автопомощь на дороге">
			

			<h3>Заказать автопомощь на дороге</h3>
			<label>
				<span>Ваше имя:</span>
				<input type="text" name="Имя" placeholder="Введите ваше имя..."></input>
			</label>
