...
<body class="isnohome">
				...
				<div class="row">
					<div class="col-md-9">
						...
						<article>
							<h1>Вип такси</h1>
							<p>
								Прокат лимузинов и авто представительского класса
							</p>
							<p>
								Важное событие? Какой автомобиль выбрать на торжество? 
								Мы предлагаем лимузины и автомобили представительского класса 
								с притягательным внешним видом и шикарным салоном. У нас Вы сможете
								арендовать автомобили как для свадебного торжества, так и для других
								праздничных мероприятий: дни рождения, корпоративы, встречи VIP- гостей,
								выпускные, прогулки по городу, трансферы.
							</p>
						</article>
					...
					<aside class="main-aside">
						...
						<div class="top-panel-box">
									...
									<ul class="menu-type-2">
										...
										<li class="active"><a href="№"><span class="fa fa-check"></span>Вип такси</a></li>
									</ul>
								</div>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="top-panel-box">
									...
									<ul class="menu-type-2ре">
										<li><a href="avtopomoshch.html"><span class="fa fa-check"></span>Автопомощь</a></li>
										<li><a href="shinomontage.html"><span class="fa fa-check"></span>Шиномонтаж</a></li>
										<li><a href="remont_motorov.html"><span class="fa fa-check"></span>Ремонт моторов</a></li>
										<li><a href="remont_akpp.html"><span class="fa fa-check"></span>Ремонт АКПП</a></li>
										<li><a href="avtopomoshch_na_doroge.html"><span class="fa fa-check"></span>Автопомощь на дороге</a></li>
										<li><a href="#"><span class="fa fa-check"></span>Вип такси</a></li>
									</ul>
								</div>
	...
	<div class="hidden">
		...
		<form class="popup-form callback zoom-anim-dialog" id="order">
			...
			<input type="hidden" name="project_name" value="Эвакуатор">
			<input type="hidden" name="admin_email" value="nx100@yandex.ru">
			<input type="hidden" name="form_subject" value="Заявка с сайта эвакуатор: заказ услуги вип такси">
			

			<h3>Заказать вип такси</h3>
			<label>
				<span>Ваше имя:</span>
				<input type="text" name="Имя" placeholder="Введите ваше имя..."></input>
			</label>
